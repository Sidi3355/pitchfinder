...
## From the iteration 3 critique (11 Sep, product only)

| #   | Item                                                                                                                                                                      | Status | Notes                                                                                 |
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ | ------------------------------------------------------------------------------------- |
| E1  | Sign-in link opened in another tab loses the pitch, group and pending action                                                                                              | done   | localStorage plus redirect to the exact page; e2e opens the link in a new tab         |
| E2  | Top pick named after a residents' gym; unknown facts outrank known ones                                                                                                   | done   | Private facilities excluded as naming sources (needs a data refresh); ranking weights |
| E3  | Same reason on every card; "(est.)" hung on the pitch count                                                                                                               | done   | Per-person minutes with source tags on the card; reasons are facts only               |
| E4  | No search by name                                                                                                                                                         | todo   | P1, iteration 7: `q=` in the URL, input above the list                                |
| E5  | Mobile pitch sheet opens at half with journeys and actions below the fold                                                                                                 | done   | Opens full on selection; journeys and actions first                                   |
| E6  | Silent time change (D7)                                                                                                                                                   | done   | Migration 0004                                                                        |
